...
LOCAL_SRC_FILES         := ../sqlite-build/sqlite3.c
LOCAL_C_INCLUDES        := ../sqlite-build
LOCAL_EXPORT_C_INCLUDES := ../sqlite-build
...
LOCAL_SRC_FILES         := ../sqlite-build/shell.c ../sqlite-build/sqlite3.c
LOCAL_C_INCLUDES        := ../sqlite-build
LOCAL_EXPORT_C_INCLUDES := ../sqlite-build
